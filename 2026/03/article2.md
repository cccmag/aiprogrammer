...
- [TypeScript 6.0 官方部落格](https://www.google.com/search?q=TypeScript+6.0+announcement)
- [TypeScript 6.0 Breaking Changes](https://www.google.com/search?q=TypeScript+6.0+breaking+changes)
