...
- [SQLite 4.0 向量搜尋](https://www.google.com/search?q=SQLite+4.0+vector+search)
- [HNSW 演算法原理](https://www.google.com/search?q=HNSW+algorithm+vector+search)
- [Embedding 模型選擇指南](https://www.google.com/search?q=sentence+transformers+embedding+models)
