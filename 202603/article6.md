...
- [OpenAI GPT-5 技術報告](https://openai.com/research/gpt-5)
- [GPT-5 API 文件](https://platform.openai.com/docs/models/gpt-5)
- [GPT-5 System Card](https://openai.com/safety-standards/gpt-5-system-card)
