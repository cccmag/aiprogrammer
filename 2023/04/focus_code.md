...
本期的主題是演算法設計與分析。為了讓理論與實踐相結合，我們用 Python 實作了五個經典演算法，分別對應五種不同的演算法設計策略。

完整的原始碼請參考：[_code/algorithm_design.py](_code/algorithm_design.py)
...
X=ABCBDAB, Y=BDCABC
LCS Length: 4, Sequence: BCAB

3. 0/1 Knapsack Problem
Weights: [10, 20, 30], Values: [60, 100, 120], Capacity: 50
Max Value: 220, Items: [1, 2]

4. Huffman Coding
Original: A SIMPLE STRING TO BE ENCODED
Encoded: 10111001010010101111110010110110000101011010111001011111110000011011110001011010000100111101100111001001000100
Codes: {' ': '00', 'D': '0100', ...}
Compression: 232 -> 110 bits

5. Ford-Fulkerson Max Flow
Max Flow from source(0) to sink(5): 23
...
- [Merge Sort Algorithm](https://www.google.com/search?q=merge+sort+algorithm)
- [Dynamic Programming](https://www.google.com/search?q=dynamic+programming+algorithm)
- [Ford-Fulkerson Algorithm](https://www.google.com/search?q=Ford-Fulkerson+max+flow)

---

*本篇文章為「AI 程式人雜誌 2023 年 4 月號」演算法實作補充文章。*
